...
function Footer() {
  return (
    <div className='w-[100%] md:h-[36vh] h-[21vh] mb-[77vh] md:mb-[0px]' >
        <div className='w-[100%] md:h-[30vh] h-[15vh] md:mb-[0px] bg-[#dbfcfcec]
            flex items-center justify-center px-[5px] md:px-[50px]'>
            <div className='md:w-[30%] w-[35%] h-[100%] flex items-start 
               justify-center flex-col gap-[5px]'>
                <div className='flex items-start justify-start gap-[5px] mt-[10px] md:mt-[40px] '>
                    <img src={logo} className='w-[30px] h-[30px] md:w-[40px] md:h-[40px] ' alt="" />

                    <p className='text-[19px] md:text-[20px] text-[black] '>LuxyCart</p>

                </div>

                <p className='text-[15px] text-[#1e2223] hidden md:block '>
                        LuxyCart is your all-in-one online shopping destination, offering 
                        top-quality products, unbeatable deals, and fast delivery-all backed
                        by trusted service designed to make your life easier everyday.
                    </p>
                    
                <p className='text-[15px] text-[#1e2223] flex md:hidden '>
                    Fast. Easy. Reliable. LuxyCart Shopping
                </p>
            </div>
            ...
            <div className='w-[30%] h-[100%] flex items-center justify-center flex-col text-center '>
                <div className='flex items-center justify-center gap-[5px] mt-[10px] md:mt-[40px] '>
                    <p className='text-[19px] md:text-[20px] text-[#1e2223] font-sans '>
                        GET IN TOUCH
                    </p>
                ...
                <ul>
                    <li className='text-[15px] text-[#1e2223] hidden md:block cursor-pointer '>+91-8416099999</li>
                    <li className='text-[15px] text-[#1e2223] cursor-pointer '>contact@luxycart.com</li>
                    <li className='text-[15px] text-[#1e2223] hidden md:block cursor-pointer '>+1-123-456-7890</li>
                    <li className='text-[15px] text-[#1e2223] cursor-pointer '>admin@luxycart.com</li>
                </ul>
            </div>
        </div>
        ...
        <div className='w-[100%] h-[6vh] bg-[#dbfcfcec] flex items-center justify-center'>
            Copyright 2025@luxycart.com-All Rights Reserved
        </div>
