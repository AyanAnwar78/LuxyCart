        ...
        <div >
         ...
         gap-[50px] lg:flex-row pt-[0px] '>
             ...
             md:gap-[10px] gap-[30px] flex-col-reverse lg:flex-row'>
                 ...
                 lf:flex-col flex-wrap '>
                        <div className='md:w-[100px] w-[50px] h-[50px] md:h-[110px]
                      bg-slate-300 border-[1px] border-[#80808049] rounded-md '>
                            <img src={image1} alt="" className='w-[100%] h-[100%] 
                          cursor-pointer rounded-md' onClick={() => setImage(image1)} />
                        </div>
                        <div className='md:w-[100px] w-[50px] h-[50px] md:h-[110px]
                      bg-slate-300 border-[1px] border-[#80808049] rounded-md' onClick={() => setImage(image2)}>
                            <img src={image2} alt="" className='w-[100%] h-[100%] cursor-pointer rounded-md' />
                        </div>
                        <div className='md:w-[100px] w-[50px] h-[50px] md:h-[110px]
                      bg-slate-300 border-[1px] border-[#80808049] rounded-md' onClick={() => setImage(image3)}>
                            <img src={image3} alt="" className='w-[100%] h-[100%] cursor-pointer rounded-md' />
                        </div>
                        <div className='md:w-[100px] w-[50px] h-[50px] md:h-[110px]
                      bg-slate-300 border-[1px] border-[#80808049] rounded-md' onClick={() => setImage(image4)}>
                            <img src={image4} alt="" className='w-[100%] h-[100%] cursor-pointer rounded-md' />
                        </div>
                    </div>

                    <div className='lg:w-[60%] w-[80%] lg:h-[78%] h-[70%] border-[1px] border-[#80808049] rounded-md
                 overflow-hidden '>
                        <img src={image} alt="" className='w-[100%] lg:h-[100%] h-[100%] text-[30px]
                      text-white text-center rounded-md object-fill ' />
                    </div>
                </div>

                <div className='lg:w-[50vw] w-[100vw] h-auto lg:mt-[80px]
              flex items-start justify-start flex-col py-[20px] px-[30px]
              md:pb-[20px] md:pl-[20px] lg:pl-[10px] lg:px-[0px] lg:py-[0px] gap-[10px] '>
                 ...
                 pl-[5px] text-white'>{currency} {productData.price}</p>

                    <p className='text-[30px] w-[80%] md:w-[60%] font-semibold
                 pl-[5px] text-white'> {productData.description} and Stylish. Easy to wash, super comfortable
                        and designed for effortless style.</p>
                        ...
                        <div className='flex gap-2'>
                            {
                                productData.sizes.map((item, index) => (
                                    <button key={index} className={`border py-2 px-4
                                  bg-slate-300 rounded-md
                                   hover:cursor-pointer
                                   ${item === size ? ' bg-red-600 text-[blue] text-[20px]' : ''}`} onClick={() => setSize(item)}>{item}</button>
                                ))
                            }
                        </div>

                        <button className='text-[16px] active:bg-slate-500 cursor-pointer bg-[#495b61c9]
                     py-[10px] px-[20px] rounded-2xl mt-[10px] border-[1px] border-[#80808049]
                     text-white shadow-md shadow-black' onClick={()=>addtoCart(productData._id, size)}  >Add to Cart</button>
                    </div>
            ...
            <div className='w-[100%] min-h-[70vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex 
           items-start justify-start flex-col overflow-x-hidden '>
                
                <div className='flex px-[20px] mt-[90px] lg:ml-[80px] ml-[0px]
              lg:mt-[0px]'>
                ...
                <div className='w-[80%] md:h-[150px] h-[220px] bg-[#3336397c] border
             text-white text-[13px] md:text-[15px] lg:text-[20px] px-[10px] md:px-[30px]
               ml-[100px] mt-[40px] '>
                    <p className='w-[85%] h-[90%] flex items-center justify-center '>
