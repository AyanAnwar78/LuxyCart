...
function Ai() {
  ...
  return (
    <div className='fixed lg:bottom-[15px] md:bottom-[30px]
      bottom-[50px] left-[4%]' 
      onClick={()=>{recognition.start();
        openingSound.play()
        setActiveAi(true)
      }}>
        {/* <div className="w-[60px] h-[60px] border-2 border-gray-400 hover:border-blue-400 flex items-center justify-center cursor-pointer transition-all duration-300"> */}
        <img
          src={ai}
          alt="AI Assistant Logo"
          className={`w-[80px] ${activeAi ? 'translate-x-[10%] translate-y-[-10%] scale-125' : 
            'translate-x-[0] translate-y-[0] scale-100'} transition-transform`} style={{
              filter: `${activeAi ? "drop-shadow(0px 0px 30px #00d2f2)" : 
