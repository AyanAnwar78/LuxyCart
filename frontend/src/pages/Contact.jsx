...
function Contact() {
  return (
    <div className='w-[99vw] md:w-[98.8vw] min-h-[100vh] flex items-center 
      ...
      to-[#0c2025] gap-[50px] pt-[80px]'>
        ...
        <div className='w-[100%] flex items-center justify-center flex-col lg:flex-row '>
          <div className='lg:w-[50%] w-[100%] flex items-center justify-center '>
            <img src={contact} alt="" className=' h-[45vh] w-[45vw] lg:w-[70%] shadow-md shadow-black rounded-sm '/>
          </div>
          ...
          <div className='lg:w-[50%] w-[80%] flex items-start justify-center gap-[20px] flex-col mt-[20px] lg:mt-[0px] '>
            ...
            <button className='px-[30px] py-[20px] flex items-center justify-center
             text-white bg-transparent border active:bg-slate-600 rounded-md cursor-pointer'>
              Explore Jobs</button>
